...
del1<-flowvars[which(flowvars$ELIGIBLE==1),] #4994
...
# Supplementary Tables Unweighted prevalences
```{r}
#S2
...
```
## Supplementary Table 3: Cancer screening
```{r}
...
## Supplementary Table 3: Primary Care  appointments cancelled by participant or provider
```{r}
...
## Supplementary Table 3: Elective surgery or procedure appointments cancelled by provider
```{r}
...
## Supplementary Table 3: Mental Health appointments cancelled by provider
```{r}
...
## Supplementary Table 3: Dermatology appointments cancelled by provider
```{r}
...
##  Supplementary Table 3: Other speciality
```{r}
...
## Supplementary table 6: Reasons for avoiding ER-Concern for COVID 
```{r}
